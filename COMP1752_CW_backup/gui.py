...
main_frame.configure(bg="light pink")
...
create_track_button = tk.Button(top_right_frame, text="Create", font=button_style["font"], fg=button_style["fg"], bg=button_style["bg"])
...
# Your Tracks List Label
your_tracks_label = tk.Label(top_right_frame, text="Your Track List", bg="light blue")
your_tracks_label.grid(row=2, column=0, sticky="w")
